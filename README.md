...
- Provide a paraphraser global examples see [sample_paraphraser_examples.json](sample_paraphraser_examples.json)
- Provide a recognizer global examples see [sample_recognizer_examples.json](sample_recognizer_examples.json)

This will improve the quality of the outputs by providing more context to the model about your domain.
